...
class CommandNotAllowedEventJdaSlashTest extends Specification {
    CommandContext<Object> commandContext = Stub()

    @Subject
    CommandNotAllowedEventJdaSlash testee = new CommandNotAllowedEventJdaSlash(commandContext)
    ...
    def '#className toString should start with class name'(testee) {
        ...
        where:
            testee                                       | _
            new CommandNotAllowedEventJdaSlash(null)     | _
            new CommandNotAllowedEventJdaSlash(null) { } | _
