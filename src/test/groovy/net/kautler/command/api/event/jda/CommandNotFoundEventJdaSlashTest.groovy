...
class CommandNotFoundEventJdaSlashTest extends Specification {
    CommandContext<Object> commandContext = Stub()

    @Subject
    CommandNotFoundEventJdaSlash testee = new CommandNotFoundEventJdaSlash(commandContext)
    ...
    def '#className toString should start with class name'(testee) {
        ...
        where:
            testee                                     | _
            new CommandNotFoundEventJdaSlash(null)     | _
            new CommandNotFoundEventJdaSlash(null) { } | _
