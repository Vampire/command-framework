...
class CommandNotFoundEventJavacordTest extends Specification {
    Message message = Stub()

    @Subject
    CommandNotFoundEventJavacord testee =
            new CommandNotFoundEventJavacord(message, 'thePrefix', 'theUsedAlias')
    ...
    def '#className toString should start with class name'() {
        ...
        where:
            testee                                                 | _
            new CommandNotFoundEventJavacord(null, null, null)     | _
            new CommandNotFoundEventJavacord(null, null, null) { } | _
