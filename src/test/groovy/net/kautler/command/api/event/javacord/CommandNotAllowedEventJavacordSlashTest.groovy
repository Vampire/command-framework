...
class CommandNotAllowedEventJavacordSlashTest extends Specification {
    CommandContext<Object> commandContext = Stub()

    @Subject
    CommandNotAllowedEventJavacordSlash testee = new CommandNotAllowedEventJavacordSlash(commandContext)
    ...
    def '#className toString should start with class name'() {
        ...
        where:
            testee                                            | _
            new CommandNotAllowedEventJavacordSlash(null)     | _
            new CommandNotAllowedEventJavacordSlash(null) { } | _
