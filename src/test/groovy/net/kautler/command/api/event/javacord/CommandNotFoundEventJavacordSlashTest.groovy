...
class CommandNotFoundEventJavacordSlashTest extends Specification {
    CommandContext<Object> commandContext = Stub()

    @Subject
    CommandNotFoundEventJavacordSlash testee = new CommandNotFoundEventJavacordSlash(commandContext)
    ...
    def '#className toString should start with class name'() {
        ...
        where:
            testee                                          | _
            new CommandNotFoundEventJavacordSlash(null)     | _
            new CommandNotFoundEventJavacordSlash(null) { } | _
