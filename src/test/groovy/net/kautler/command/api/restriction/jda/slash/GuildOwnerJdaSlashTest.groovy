...
@EnableWeld
class GuildOwnerJdaSlashTest extends Specification {
    @WeldSetup
    def weld = WeldInitiator
            .from(GuildOwnerJdaSlash)
            .inject(this)
            .build()

    @Inject
    @Subject
    GuildOwnerJdaSlash guildOwnerJdaSlash
    ...
    def 'guild owner "#guildOwner" should #be allowed'() {
        ...
        expect:
            !guildOwnerJdaSlash.allowCommand(commandContext)
            guildOwnerJdaSlash.allowCommand(guildCommandContext) == allowed
