...
class NoneOfTest extends Specification {
    Restriction<Object> restriction1 = Stub()

    Restriction<Object> restriction2 = Stub()

    @Subject
    NoneOf<Object> noneOf = Spy(constructorArgs: [restriction1, restriction2])

    def 'none of [restriction1Allowed: #restriction1Allowed, restriction2Allowed: #restriction2Allowed] should #be allowed'() {
        given:
