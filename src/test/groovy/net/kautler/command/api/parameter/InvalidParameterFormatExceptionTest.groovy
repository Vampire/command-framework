...
@Subject(InvalidParameterFormatException)
class InvalidParameterFormatExceptionTest extends Specification {
    def 'constructor should set message'() {
        given:
            def random = randomUUID() as String

        when:
            def testee = new InvalidParameterFormatException(random)
    ...
    def 'constructor should set message and cause'() {
        ...
        when:
            def testee = new InvalidParameterFormatException(random, exception)
