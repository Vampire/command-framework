...
class BotOwnerJavacordIntegTest extends Specification {
    ...
    @ResourceLock('net.kautler.command.integ.test.javacord.restriction.BotOwnerJavacordIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.javacord.restriction.BotOwnerJavacordIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.javacord.restriction.BotOwnerJavacordIntegTest.IgnoreOtherTestsTransformer.expectedContent')
