...
import net.kautler.command.api.prefix.javacord.MentionPrefixProviderJavacord
...
@Subject([MentionPrefixProviderJavacord, CommandHandler])
class MentionPrefixProviderJavacordIntegTest extends Specification {
    @AddBean(MyPrefix)
    @AddBean(PingCommand)
    ...
    @Vetoed
    @ApplicationScoped
    static class MyPrefix extends MentionPrefixProviderJavacord {
    }
}
