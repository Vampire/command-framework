 ...
 */
public class CommandNotFoundEventJdaSlash extends CommandEvent<SlashCommandInteraction> {
    /**
     ...
     */
    public CommandNotFoundEventJdaSlash(CommandContext<SlashCommandInteraction> commandContext) {
