 ...
 */
public class CommandNotFoundEventJavacordSlash extends CommandEvent<SlashCommandInteraction> {
    /**
     ...
     */
    public CommandNotFoundEventJavacordSlash(CommandContext<SlashCommandInteraction> commandContext) {
