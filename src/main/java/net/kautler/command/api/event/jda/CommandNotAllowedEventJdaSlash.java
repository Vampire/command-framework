 ...
 * configured {@link RestrictedTo restriction} by the JDA slash command handler. It can be handled using
 * {@link ObservesAsync @ObservesAsync}.
 *
 * @see ObservesAsync @ObservesAsync
 * @see RestrictedTo @RestrictedTo
 */
public class CommandNotAllowedEventJdaSlash extends CommandEvent<SlashCommandInteraction> {
    /**
     ...
     */
    public CommandNotAllowedEventJdaSlash(CommandContext<SlashCommandInteraction> commandContext) {
