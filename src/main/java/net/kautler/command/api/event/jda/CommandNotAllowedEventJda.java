 ...
 * configured {@link RestrictedTo restriction} by the JDA command handler. It can be handled using
 * {@link ObservesAsync @ObservesAsync}.
 *
 * @see ObservesAsync @ObservesAsync
 * @see RestrictedTo @RestrictedTo
 */
public class CommandNotAllowedEventJda extends CommandEvent<Message> {
    /**
     ...
     */
    public CommandNotAllowedEventJda(CommandContext<Message> commandContext) {
