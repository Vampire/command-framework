 ...
 */
public abstract class ChannelJda implements Restriction<Message> {
    /**
     ...
     */
    private ChannelJda(Parameters parameters) {
    ...
    private boolean allowCommandByChannelId(Message message) {
        return message.getChannel().getIdLong() == channelId;
    }
    ...
    /**
     * A set of parameters to construct a channel restriction for JDA.
     */
