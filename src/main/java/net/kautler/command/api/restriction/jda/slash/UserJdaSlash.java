...
/**
 * A restriction that allows a command for certain users and is evaluated by the JDA slash command handler.
 ...
 */
public abstract class UserJdaSlash implements Restriction<SlashCommandInteraction> {
    /**
     ...
     */
    protected UserJdaSlash(long userId) {
     ...
     */
    protected UserJdaSlash(String userName) {
     ...
     */
    protected UserJdaSlash(String userName, boolean caseSensitive) {
     ...
     */
    protected UserJdaSlash(Pattern userPattern) {
     ...
     */
    private UserJdaSlash(Parameters parameters) {
    ...
    private boolean allowCommandByUserId(SlashCommandInteraction slashCommandInteraction) {
        return Optional.of(slashCommandInteraction.getUser())
    ...
    /**
     * A set of parameters to construct a user restriction for JDA with slash commands.
     */
