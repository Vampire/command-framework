...
/**
 * A restriction that allows a command for server managers and is evaluated by the JDA slash command handler.
 * If a message is not sent on a guild, this restriction always denies.
 */
@ApplicationScoped
public class ServerManagerJdaSlash implements Restriction<SlashCommandInteraction> {
    /**
     * Constructs a new server manager restriction for JDA slash commands.
     */
    public ServerManagerJdaSlash() {
