 ...
 */
@ApplicationScoped
public class NsfwChannelJavacordSlash implements Restriction<SlashCommandInteraction> {
    /**
     * Constructs a new NSFW channel restriction for Javacord slash commands.
     */
    public NsfwChannelJavacordSlash() {
