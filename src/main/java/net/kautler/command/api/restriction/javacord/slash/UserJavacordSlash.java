...
public abstract class UserJavacordSlash implements Restriction<SlashCommandInteraction> {
     ...
     */
    private UserJavacordSlash(Parameters parameters) {
    ...
    /**
     * A set of parameters to construct a user restriction for Javacord with slash commands.
     */
    private static class Parameters {
         ...
         *                      to determine for whom a command should be allowed
         */
        private Parameters(long userId, String userName,
