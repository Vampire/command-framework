...
public interface CommandContextTransformer<M> {
     ...
     *
     * <p>If at the end of the initialization phase, any before, or any after sub phase the command is set
     ...
     *
     * <p>If at the end of the initialization phase, any before, or any after sub phase before the
