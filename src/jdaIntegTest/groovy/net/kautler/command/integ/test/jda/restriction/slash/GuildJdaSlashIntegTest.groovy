...
import net.kautler.command.api.restriction.jda.slash.GuildJdaSlash
...
class GuildJdaSlashIntegTest extends DiscordGebSpec {
    @AddBean(Guild)
    @AddBean(PingCommand)
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.Guild.criterion')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if not in correct guild by id'(TextChannel textChannelAsBot) {
        given:
            Guild.criterion = 1
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if in correct guild by id'(TextChannel textChannelAsBot) {
        given:
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if not in correct guild by name'(TextChannel textChannelAsBot) {
        given:
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if in correct guild by name'(TextChannel textChannelAsBot) {
        given:
    ...
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.GuildCaseInsensitive.guildName')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommandCaseInsensitive.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommandCaseInsensitive.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if not in correct guild by name case-insensitively'(TextChannel textChannelAsBot) {
        given:
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommandCaseInsensitive.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if in correct guild by name case-insensitively'(TextChannel textChannelAsBot) {
        given:
            def guildName = textChannelAsBot.guild.name.toUpperCase()
            if (guildName == textChannelAsBot.guild.name) {
                guildName = textChannelAsBot.guild.name.toLowerCase()
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if not in correct guild by pattern'(TextChannel textChannelAsBot) {
        given:
            Guild.criterion = ~/[^\w\W]/
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if in correct guild by pattern'(TextChannel textChannelAsBot) {
        given:
            Guild.criterion = ~/.*/
    ...
    @Vetoed
    @ApplicationScoped
    static class Guild extends GuildJdaSlash {
    ...
    @Vetoed
    @ApplicationScoped
    static class GuildCaseInsensitive extends GuildJdaSlash {
