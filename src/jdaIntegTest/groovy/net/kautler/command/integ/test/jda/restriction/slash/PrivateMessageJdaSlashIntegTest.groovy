...
import net.kautler.command.api.restriction.jda.slash.PrivateMessageJdaSlash
...
@Subject(PrivateMessageJdaSlash)
@Tag('manual')
@AddBean(SlashCommandRegisterer)
class PrivateMessageJdaSlashIntegTest extends DiscordGebSpec {
    @AddBean(PingCommand)
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.PrivateMessageJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.PrivateMessageJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.PrivateMessageJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if in server channel'(TextChannel textChannelAsBot) {
        given:
    ...
    @RestrictedTo(PrivateMessageJdaSlash)
