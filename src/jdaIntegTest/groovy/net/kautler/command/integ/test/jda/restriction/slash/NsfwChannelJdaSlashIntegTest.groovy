...
import net.kautler.command.api.restriction.jda.slash.NsfwChannelJdaSlash
...
@Subject(NsfwChannelJdaSlash)
@Tag('manual')
@AddBean(SlashCommandRegisterer)
class NsfwChannelJdaSlashIntegTest extends DiscordGebSpec {
    @AddBean(PingCommand)
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.NsfwChannelJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.NsfwChannelJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.NsfwChannelJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if in non-nsfw server channel'(TextChannel textChannelAsBot) {
        given:
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.NsfwChannelJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.NsfwChannelJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if in nsfw server channel'(TextChannel textChannelAsBot) {
        given:
            ...
            textChannelAsBot.manager.setNSFW(true).complete()
    ...
    @RestrictedTo(NsfwChannelJdaSlash)
