...
class GuildOwnerJdaIntegTest extends Specification {
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.GuildOwnerJdaIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.GuildOwnerJdaIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.GuildOwnerJdaIntegTest.IgnoreOtherTestsTransformer.expectedContent')
