...
import net.kautler.command.api.restriction.jda.slash.GuildOwnerJdaSlash
...
@Subject(GuildOwnerJdaSlash)
@Tag('manual')
@AddBean(SlashCommandRegisterer)
class GuildOwnerJdaSlashIntegTest extends DiscordGebSpec {
    @AddBean(PingCommand)
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildOwnerJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildOwnerJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildOwnerJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should not respond if not server owner'(TextChannel textChannelAsBot) {
        given:
            IgnoreOtherTestsTransformer.expectedContent = "/${PingCommand.alias}"
            def commandNotAllowedEventReceived = new BlockingVariable<Boolean>(System.properties.testResponseTimeout as double)
            PingCommand.commandNotAllowedEventReceived = commandNotAllowedEventReceived
            assert System.properties.testDiscordUserId != textChannelAsBot.guild.ownerId
    ...
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildOwnerJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.restriction.slash.GuildOwnerJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'ping command should respond if server owner'(TextChannel textChannelAsBot) {
        given:
            IgnoreOtherTestsTransformer.expectedContent = "/${PingCommand.alias}"
    ...
    @RestrictedTo(GuildOwnerJdaSlash)
