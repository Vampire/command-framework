...
@Subject(CommandNotAllowedEventJdaSlash)
@Tag('manual')
@AddBean(SlashCommandRegisterer)
class CommandNotAllowedEventJdaSlashIntegTest extends DiscordGebSpec {
    @AddBean(False)
    @AddBean(PingCommand)
    @AddBean(IgnoreOtherTestsTransformer)
    @ResourceLock('net.kautler.command.integ.test.jda.event.CommandNotAllowedEventJdaSlashIntegTest.PingCommand.alias')
    @ResourceLock('net.kautler.command.integ.test.jda.event.CommandNotAllowedEventJdaSlashIntegTest.PingCommand.commandNotAllowedEventReceived')
    @ResourceLock('net.kautler.command.integ.test.jda.event.CommandNotAllowedEventJdaSlashIntegTest.IgnoreOtherTestsTransformer.expectedContent')
    def 'command not allowed event should be fired if restriction denied command'(TextChannel textChannelAsBot) {
        given:
